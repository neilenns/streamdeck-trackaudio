...
| Show last four received callsigns | When checked, the last four unique received callsigns will be appended to the action title, newest to oldest. Only supported when listen to is set to `RX` or `XCA`. | Disabled                                                        |
