...
| Show last callsigns         | Sets the number of last received callsigns to display, newest to oldest. Only supported when listen to is set to `RX` or `XCA`. If set to `0` no last received callsigns will be shown. | `0`                                                             |
